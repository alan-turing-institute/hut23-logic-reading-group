...
\sidenote*{The book calls the logic developed in parts II to~IV\ \emph{truth-functional logic}, or TFL\@.  Truth-functional logics is also known as \emph{propositional logic} and sometimes \emph{sentential logic}. The \emph} } 
