...
\NewDocumentCommand\defn{sO{#3}m}{\textit{#3}\IfBooleanF{#1}{\sidenote*{#2}}}
...
\defn[necessary truth / falsehood]{necessarily true}. For example: ``The number 7 is either odd or
