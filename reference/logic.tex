...
\sidenote*{The book calls the logic developed in parts II to~IV\ \emph{truth-functional logic}, or TFL\@.  Truth-functional logic is also known as \emph{propositional logic} and sometimes \emph{sentential logic} (see Appendex A.1 of the book).  The Stanford Encyclopedia of Philosophy calls it propositional logic, so that is what I shall do.}
