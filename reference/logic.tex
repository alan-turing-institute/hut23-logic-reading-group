...
The language defined by figure~\ref{fig:bnf-prop} is the \defn{object
  language} of propositional logic. Terms \emph{used} in the definition
are said to be part of the \defn{metalanguage}. The script letters,
`\wff{S}', and so on, are called \defn{metavariables} and are part of
the metalanguage. The symbol `$\therefore$', used to indicate which sentence is the conclusion of an argument, is also part of the metalanguage.  
