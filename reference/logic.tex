...
following rules: \sidenote*{I tend to think of the \emph{real} thing as
  a kind of tree, or perhaps a data type.  The sentence is just how we
  ...
  conjunction.  The only reason we care about how we write it is to ensure that we can recover the real thing given the written form. }
\begin{enumerate}
