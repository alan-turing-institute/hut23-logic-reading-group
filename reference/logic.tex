...
each representing a valuation of the component parts of the sentence and
the value of the whole sentence. (The truth value of a compound sentence
is determined entirely by the truth values of its constituent parts and
the particular connective.) See figure~\ref{fig:truthtables} for complete truth tables of the standard connectives.
\begin{figure}[ht]
